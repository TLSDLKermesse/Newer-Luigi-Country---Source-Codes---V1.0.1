...
int dMakeYourOwn::onCreate() {
	...
	//CREDITS SHIT
		...
		case 50:		// 100% Completion Waluigi

			setupModel("CompletionContent", "g3d/WaluigiEnd.brres", "Waluigi"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = -3000.0;

				setupAnim("TheFlatteningGuy", 1.0); 
			break;	

		case 51:		// 100% Completion Wario

			setupModel("CompletionContent", "g3d/WarioEnd.brres", "Wario"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = -3000.0;

				setupAnim("anim51", 1.0); 
			break;	

		case 52:		// Ghostly 3D Tree
		...
		case 53:		// 100% Completion Restored Luigiship

			setupModel("CompletionContent", "g3d/LuigiShipEnd.brres", "KurayamiHikousen"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;

				setupAnim("Animation_Floatship", 1.0); 
			break;	
	
		case 54:		// Unused Model - Layer 2 Volcano

			setupModel("UnusedContent", "g3d/Unused54.brres", "Volcano"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;
		...
		case 55:		// Ending King Boo State

			setupModel("EndingScene", "g3d/king_boo_dead.brres", "king_boo_dead"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;

				setupAnim("anim55", 1.0); 
			break;	
	
		case 56:		// King Boo's Crystal

			setupModel("EndingScene", "g3d/crystal.brres", "crystal"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;
		...
		case 57:		// Ending Wall Rocks - Model 1

			setupModel("EndingScene", "g3d/wall_pieces.brres", "wallpiece01"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;

				setupAnim("wallpiece00", 1.0); 
			break;	
		
		case 58:		// Ending Wall Rocks - Model 2

			setupModel("EndingScene", "g3d/wall_pieces.brres", "wallpiece02"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;
		...
		case 59:		// Ending Wall Rocks - Model 3

			setupModel("EndingScene", "g3d/wall_pieces.brres", "wallpiece03"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;

				setupAnim("wallpiece01", 1.0); 
			break;				

		case 60:		// Ending Wall Rocks - Model 4

			setupModel("EndingScene", "g3d/wall_pieces.brres", "wallpiece04"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;
		...
		case 61:		// Ending Wall Rocks - Model 5

			setupModel("EndingScene", "g3d/wall_pieces.brres", "wallpiece05"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;

				setupAnim("wallpiece02", 1.0); 
			break;				

		case 62:		// Ending Wall Rocks - Model 6

			setupModel("EndingScene", "g3d/wall_pieces.brres", "wallpiece06"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;
		...
		case 63:		// Ending Tree Background

			setupModel("EndingScene", "g3d/EndingTreeBG.brres", "EndingBG1"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;

				setupAnim("Ending01", 1.0); 
			break;	
			
		case 64:		// Ending Luigi - A special case so my advice is to not modify this brres

			setupModel("EndingScene", "g3d/EndingLuigi.brres", "Luigihmmm"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;

				for (int i = 0; i < 4; i++) {
					bindAnimChr_and_setUpdateRate("EndingLuigi01", 1, 0.0, 1.0);
					for (int ii = i < 61 ; ii++) {
						this->speed.x = 0.1f;
					}
				...
				bindAnimChr_and_setUpdateRate("EndingLuigi02", 1, 0.0, 1.0);
				
				for (i = 0; i < 3; i++) {
					bindAnimChr_and_setUpdateRate("EndingLuigi03", 1, 0.0, 1.0);
					Stop(37);
				}
				
				bindAnimChr_and_setUpdateRate("EndingLuigi04", 1, 0.0, 1.0);
				
				//I'm wondering if this'll work. Please correct it if there're errors.
			break;	
			
		case 65:		// Credits Mario Model

			setupModel("EndingScene", "g3d/CreditsMario.brres", "mario"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;

				setupAnim("anim65", 1.0); 
			break;	
		
		case 66:		// Credits Wario Model

			setupModel("EndingScene", "g3d/CreditsWario.brres", "wario"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = 0.0;

				setupAnim("anim66", 1.0); 
			break;	

		case 67:		// Bright BG's upcoming comet

			setupModel("CompletionContent", "g3d/starComet.brres", "CometStar"); 
			SetupTextures_MapObj(&bodyModel, 0);
			this->pos.z = -3000.0;

				setupAnim("anim67", 1.0); 
			break;	
	}
