...
const char* Prizes[14][4] = {
	...
	{ "I_musasabi",		"g3d/I_musasabi.brres",			"I_musasabi",			"wait2"	},
	{ "I_hammer",		"g3d/I_boomerang.brres",		"I_boomerang",			"wait2"	},
	{ "obj_coin_big",	"g3d/obj_coin_big.brres",		"Coin50",				"wait2"	},
	{ "I_bigKinoko",	"g3d/I_bigKinoko.brres",		"I_bigKinoko",			"wait2" }
};

//4 new prizes have been added at the bottom of the list :)
...
int dSingAlong::onCreate() {
	...
	this->Powerups[10] = 0; // Acorn
	this->Powerups[11] = 0; // Boomerang
	this->Powerups[12] = 0; // 50 Coins
	this->Powerups[13] = 0; // Mega Mushroom
...
void dSingAlong::addPowerups() {
	...
	for (int i = 0; i < 4; i++) { // Make sure all players get the reward!
		...
		if (block->player_lives[i] > 9999) { block->player_lives[i] = 9999; }
	}
