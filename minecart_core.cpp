...
#include <profile.h>
Profile MinecartProfile(&dScMinecart_c::build, SpriteId::497, &MinecartSpriteData, ProfileId::97, ProfileId::97, "T_Rex", rex);
//I made some edits manually. Please help me checking it cuz idanything. :|
