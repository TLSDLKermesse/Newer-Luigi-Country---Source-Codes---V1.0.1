...
void getNewerLevelNumberString(int world, int level, wchar_t *dest) {
	static const wchar_t *numberKinds[] = {
		...
		L"Tank" //43, Tank
		L"Donkey Kong" //44 DK Levels
		L"Mega Mushroom" //45 Mega Mushroom Test
		L"New Sprites' Test" //46
		L"BRRES' test" //47 BRRES files' test
		L"\x0B\x0149\xBEEF" //50 Tank (into its picture form)
		L"\x0B\x0131\xBEEF" //51 Warp Cannon
		L"\x0B\x0134\xBEEF" //52 Horizontal Arrow Knot
		L"\x0B\x0135\xBEEF" //53 Vertical Arrow Knot
		L"\x0B\x013F\xBEEF" //54 Airship's Ancient Mark
		L"\x0B\x0130\xBEEF" //55 Ghost House
		L"\0xB\x0136\xBEEF" //56 Empty Knot
		L"\x0B\x0137\xBEEF" //57 Peach's Castle (New)
		L"\x0B\x014F\xBEEF" //58 Star Coin Register
		L"\x0B\x0146\xBEEF" //59 Msg Box Spawner (lel)
		L"CustomName1" //60 Unused (To edit in code machine modifier)
		L"CustomName2" //61 Same
		L"CustomName3" //62 Same
	};
