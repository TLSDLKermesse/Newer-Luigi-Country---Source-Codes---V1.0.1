...
dBoomerangSuitRenderer_c *dBoomerangSuitRenderer_c::build() {
	return new dBoomerangSuitRenderer_c;
}

dAcornSuitRenderer_c *dAcornSuitRenderer_c::build() {
	return new dAcornSuitRenderer_c;
}
