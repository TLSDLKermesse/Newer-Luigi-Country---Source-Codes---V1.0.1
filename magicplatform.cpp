...
class daEnMagicPlatform_c : public dEn_c {
	public:
		...
		enum CollisionType {
			...
			ThinLineBottom = 6,
			NoneWithZ500 = 7,
			GentleUpwardslide2Block = 8,
			GentleUpwardslide1Block = 9,
			GentleDownwardslide2Block = 10,
			GentleDownwardslide1Block = 11,
			GentleUpwardCelling2Block = 12,
			GentleUpwardCelling1Block = 13,
			GentleDownwardCelling2Block = 14,
			GentleDownwardCelling1Block = 15
		};
